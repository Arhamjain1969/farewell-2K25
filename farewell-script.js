// ============================================================
// FAREWELL CARD SCRIPT (moved into /farewell folder)
// ============================================================
...
function downloadCard() {
    ...
    const filename = `farewell-${name}-${timestamp}`;
...
function downloadAsPDF(filename) {
    ...
    html += `</head><body style="margin: 20px; background: linear-gradient(135deg, rgba(0, 20, 60, 0.95) 0%, rgba(0, 0, 0, 1) 50%, rgba(10, 40, 80, 0.9) 100%); min-height: 100vh; display: flex; justify-content: center; align-items: center;">`;
    html += card.outerHTML;
    html += '</body></html>';
